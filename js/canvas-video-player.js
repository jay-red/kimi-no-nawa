...
CanvasVideoPlayer.prototype.bind = function() {
	...
	this.canvas.addEventListener('touchstart', cvpHandlers.canvasTouchStartHandler = function() {
		self.play();
	});
	
	this.canvas.addEventListener('touchend', cvpHandlers.canvasTouchEndHandler = function() {
		self.pause();
	});	
	...
	this.unbind = function() {
		this.canvas.removeEventListener('touchstart', cvpHandlers.canvasTouchStartHandler);
		this.canvas.removeEventListener('touchend', cvpHandlers.canvasTouchEndHandler);
